class Api::V1::CuentaBancosController < ApplicationController
  ...
  private
    ...
    def cuenta_banco_params
      params.require(:cuenta_banco).permit(:numero_cuenta, :tipo_moneda, :saldo, :fecha_apertura, :estado, :fecha_cierre ,:id_contacto)
    end
end
