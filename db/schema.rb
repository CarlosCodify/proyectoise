...
ActiveRecord::Schema[7.0].define(version: 2023_04_02_061738) do
  ...
  create_table "catalogo", id: :serial, force: :cascade do |t|
    ...
    t.string "codigo_proveedor", limit: 20, null: false
    t.string "descripcion", limit: 255
    t.string "activo", limit: 1, default: "A"
  ...
  create_table "concepto_movimiento_banco", force: :cascade do |t|
    t.string "nombre", limit: 255
  end
  ...
  create_table "inventario", primary_key: ["id_almacen", "id_catalogo"], force: :cascade do |t|
    t.integer "id_almacen", null: false
    t.integer "id_catalogo", null: false
    t.decimal "costo_actual", precision: 12, scale: 5, default: "0.0", null: false
  ...
  create_table "movimiento_banco", force: :cascade do |t|
  ...
  create_table "retiro", force: :cascade do |t|
    t.integer "id_movimiento_banco"
  end
