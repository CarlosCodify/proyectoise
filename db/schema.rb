...
ActiveRecord::Schema[7.0].define(version: 20_230_321_194_246) do
  ...
  create_table 'ajuste_detalle', id: :serial, force: :cascade do |t|
    ...
    t.check_constraint "tipo_ajuste = 'S'::bpchar OR tipo_ajuste = 'R'::bpchar",
                       name: 'ajuste_detalle_tipo_ajuste_check'
  end
  ...
  create_table 'inventario', primary_key: %w[id_almacen id_catalogo], force: :cascade do |t|
    t.integer 'id_almacen', null: false
    t.integer 'id_catalogo', null: false
  ...
  add_foreign_key 'activo_fijo', 'tipo_activo_fijo', column: 'id_tipo_activo_fijo',
                                                     name: 'activo_fijo_id_tipo_activo_fijo_fkey'
  ...
  add_foreign_key 'cliente', 'categoria_cliente', column: 'id_categoria_cliente',
                                                  name: 'cliente_id_categoria_cliente_fkey'
  ...
  add_foreign_key 'deposito', 'movimiento_banco', column: 'id_movimiento_banco',
                                                  name: 'deposito_id_movimiento_banco_fkey'
  ...
  add_foreign_key 'egreso_caja', 'movimiento_caja', column: 'id_movimiento_caja',
                                                    name: 'egreso_caja_id_movimiento_caja_fkey'
  add_foreign_key 'egreso_cuentas_pagar', 'cxp', column: 'id_cxp', name: 'egreso_cuentas_pagar_id_cxp_fkey'
  add_foreign_key 'egreso_cuentas_pagar', 'ingreso_caja', column: 'id_egreso_caja',
                                                          name: 'egreso_cuentas_pagar_id_egreso_caja_fkey'
  ...
  add_foreign_key 'ingreso_caja', 'movimiento_caja', column: 'id_movimiento_caja',
                                                     name: 'ingreso_caja_id_movimiento_caja_fkey'
  add_foreign_key 'ingreso_cuentas_cobrar', 'cxc', column: 'id_cxc', name: 'ingreso_cuentas_cobrar_id_cxc_fkey'
  add_foreign_key 'ingreso_cuentas_cobrar', 'ingreso_caja', column: 'id_ingreso_caja',
                                                            name: 'ingreso_cuentas_cobrar_id_ingreso_caja_fkey'
  add_foreign_key 'ingreso_cuotas', 'cuota', column: 'id_cuota', name: 'ingreso_cuotas_id_cuota_fkey'
  add_foreign_key 'ingreso_cuotas', 'ingreso_caja', column: 'id_ingreso_caja',
                                                    name: 'ingreso_cuotas_id_ingreso_caja_fkey'
  ...
  add_foreign_key 'movimiento_banco', 'concepto_movimiento_banco', column: 'id_concepto_movimiento_banco',
                                                                   name: 'movimiento_banco_id_concepto_movimiento_banco_fkey'
  add_foreign_key 'movimiento_banco', 'cuenta_banco', column: 'id_cuenta_banco',
                                                      name: 'movimiento_banco_id_cuenta_banco_fkey'
  ...
  add_foreign_key 'movimiento_caja', 'concepto_movimiento_caja', column: 'id_concepto_movimiento_caja',
                                                                 name: 'movimiento_caja_id_concepto_movimiento_caja_fkey'
  ...
  add_foreign_key 'traspaso', 'concepto_traspaso', column: 'id_concepto_traspaso',
                                                   name: 'traspaso_id_concepto_traspaso_fkey'
